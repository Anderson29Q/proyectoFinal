                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="accionesServlet?accion=listar-reportes" class="nav-link active">
                        ...
                        <form action="accionesServlet" method="GET">
                            <div class="panel">
                                ...
                                <div class="container">
                                    ...
                                    <input name="busq" type="number" class="w-50" style="    border-radius: 5px; /* Ajusta según sea necesario para redondear los bordes */
                                    ...
                                    <button name="accion" value="buscarformulario" class="btn btn-dark mx-2">
                                ...
                                <div class="panel-body table-responsive" >
                                    <div class="panel-body table-responsive">
                                        <table class="table table-bordered custom-table scrollable-table">
                                            <thead class="position-sticky bg-dark">
                                                <tr>   
                                                    ...
                                                    <th>Documentacion Enviada a Senescyt</th>
                                                    <th>Documentacion Validada</th>
                                            ...
                                            <tbody>
                                                <% List<gestion> listaformulario = (List<gestion>) request.getAttribute("listareporte");
                                                    if (listaformulario != null && !listaformulario.isEmpty()) {
                                                        for (gestion form : listaformulario) {%>
                                                <tr> 

                                                    <td><%=form.getCedula()%></td>
                                                    <td><%=form.getNombre()%></td>
                                                    <td><%=form.getApellido()%></td>
                                                    <td><%=form.getTipo()%></td>
                                                    <td><%=form.getCarrera()%></td>
                                                    <td><%=form.getFecha_revision()%></td>
                                                    <td><%=form.getDocumentacion_entregada()%></td>
                                                    <td><%=form.getDocumentacion_senescyt()%></td>
                                                    <td><%=form.getDocumentacion_validada()%></td>
                                                    <td><%=form.getNumero_documento_senescyt()%></td>
                                                    <td><%=form.getEstado_beca()%></td>
                                                    <td>  
                                                        <a href="accionesServlet?accion=editar-ges&ids=<%=form.getId()%>" class="btn btn-warning btn-sm  mb-2"> 
                                                            <i class="fas fa-edit"></i> Editar</a> 

                                                        <a href="#" onclick="confirmarEliminacion('<%=form.getId()%>')" class="btn btn-danger btn-sm">
                                                            <i class="fas fa-trash"></i> Eliminar
                                                        </a>

                                                        <script>
                                                            function confirmarEliminacion(id) {
                                                            // Mostrar una notificación flotante de confirmación
                                                            if (confirm("¿Realmente quieres eliminar la beca?")) {
                                                            // Si el usuario hace clic en "Aceptar", redirige a la URL de eliminación
                                                            window.location.href = "accionesServlet?accion=eliminar-gestion&idgest=" + id;
                                                            } else {
                                                            }
                                                            }
                                                        </script>
